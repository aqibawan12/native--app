...
import { NativeBaseProvider, Box, Text, Heading, VStack, FormControl, Input, Link,
     Button, Icon, HStack, Center, Pressable } from 'native-base';
import { MaterialCommunityIcons, MaterialIcons } from '@expo/vector-icons';

function Example() {
  const [selected, setSelected] = React.useState(1);
  return <NativeBaseProvider>
    <Box flex={1} bg="white" safeAreaBottom width="100%" maxW="109%" maxHeight="99px" alignSelf="center">
       
        <HStack bg="indigo.600" alignItems="center" safeAreaTop shadow={3}  width="100%" >
          <Pressable cursor="pointer" opacity={selected === 0 ? 1 : 0.5} py="1" flex={1} onPress={() => setSelected(0)}>
            <Center>
